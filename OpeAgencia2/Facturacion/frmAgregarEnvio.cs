...
namespace OpeAgencia2.Facturacion
{
    public partial class frmAgregarEnvio : Form
    {
        ...
        bool Validaciones()
        {
            ...
            {
                MessageBox.Show("El peso del envío debe ser mayore que 0", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error);
                bRetorno = false;
            ...
            {
                MessageBox.Show("Deber revisar la Ciudad/region del consignatario", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error);
                bRetorno = false;
