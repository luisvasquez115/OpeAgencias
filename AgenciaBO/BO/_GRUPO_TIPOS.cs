...
{
 	public abstract class  _GRUPO_TIPOS : SqlClientEntity
	{
	  public _GRUPO_TIPOS()
		{
		  this.QuerySource = "GRUPO_TIPOS";
			this.MappingName = "GRUPO_TIPOS";
		 }
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[proc_GRUPO_TIPOSLoadAll]", parameters);
		}
		
		public virtual bool LoadByPrimaryKey(int GRUPO_TIPO_ID)
		 {
		   ListDictionary parameters = new ListDictionary();
		   
		   parameters.Add(Parameters.GRUPO_TIPO_ID, GRUPO_TIPO_ID);

		   
		   return base.LoadFromSql("[proc_GRUPO_TIPOSLoadByPrimaryKey]", parameters);
		  }
		  ...
		  static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				 {
					ht = new Hashtable();
					ht[GRUPO_TIPO_ID]=_GRUPO_TIPOS.PropertyNames.GRUPO_TIPO_ID;
ht[CODIGO]=_GRUPO_TIPOS.PropertyNames.CODIGO;
ht[NOMBRE]=_GRUPO_TIPOS.PropertyNames.NOMBRE;
ht[DESCR]=_GRUPO_TIPOS.PropertyNames.DESCR;
		  ...
		  static public string ToColumnName(string propertyName)
			{
			  if(ht == null)
				{
				  ht = new Hashtable();
				        ht[GRUPO_TIPO_ID]=_GRUPO_TIPOS.ColumnNames.GRUPO_TIPO_ID;
      ht[CODIGO]=_GRUPO_TIPOS.ColumnNames.CODIGO;
      ht[NOMBRE]=_GRUPO_TIPOS.ColumnNames.NOMBRE;
      ht[DESCR]=_GRUPO_TIPOS.ColumnNames.DESCR;
...
_DESCR_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[proc_GRUPO_TIPOSInsert]";
	
			CreateParameters(cmd);
			
			 SqlParameter p;

			p = cmd.Parameters[Parameters.GRUPO_TIPO_ID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[proc_GRUPO_TIPOSUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
		    cmd.CommandText = "[proc_GRUPO_TIPOSDelete]";
