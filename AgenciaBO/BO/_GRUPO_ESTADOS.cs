...
{
 	public abstract class  _GRUPO_ESTADOS : SqlClientEntity
	{
	  public _GRUPO_ESTADOS()
		{
		  this.QuerySource = "GRUPO_ESTADOS";
			this.MappingName = "GRUPO_ESTADOS";
		 }
		...
		public virtual bool LoadByPrimaryKey(int GRUPO_EST_ID)
		 {
		   ListDictionary parameters = new ListDictionary();
		   
		   parameters.Add(Parameters.GRUPO_EST_ID, GRUPO_EST_ID);

		   
		   return base.LoadFromSql("[proc_GRUPO_ESTADOSLoadByPrimaryKey]", parameters);
		  }
		  ...
		  static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				 {
					ht = new Hashtable();
					ht[GRUPO_EST_ID]=_GRUPO_ESTADOS.PropertyNames.GRUPO_EST_ID;
ht[CODIGO]=_GRUPO_ESTADOS.PropertyNames.CODIGO;
ht[NOMBRE]=_GRUPO_ESTADOS.PropertyNames.NOMBRE;
ht[DESCR]=_GRUPO_ESTADOS.PropertyNames.DESCR;
		  ...
		  static public string ToColumnName(string propertyName)
			{
			  if(ht == null)
				{
				  ht = new Hashtable();
				        ht[GRUPO_EST_ID]=_GRUPO_ESTADOS.ColumnNames.GRUPO_EST_ID;
      ht[CODIGO]=_GRUPO_ESTADOS.ColumnNames.CODIGO;
      ht[NOMBRE]=_GRUPO_ESTADOS.ColumnNames.NOMBRE;
      ht[DESCR]=_GRUPO_ESTADOS.ColumnNames.DESCR;
...
_DESCR_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[proc_GRUPO_ESTADOSInsert]";
	
			CreateParameters(cmd);
			
			 SqlParameter p;

			p = cmd.Parameters[Parameters.GRUPO_EST_ID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[proc_GRUPO_ESTADOSUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
		    cmd.CommandText = "[proc_GRUPO_ESTADOSDelete]";
